...
export default function BlogPage() {
  const blogs = [
    ...
    },
    {
      ...
      content: `Financial struggles can feel overwhelming, but they often hold the key to life-changing transformations. In 2014, I faced a turning point: losing my job after 22 years, left with just ₹7,000 in my account, ₹17 lakh in loans, and defaulting EMIs. It was a time of despair, but it also sparked my journey toward financial mastery.  
    ...
    {
      title: "Stepping out of Comfort Zone = Expanding your Income Zone",
    ...
    },
    {
      ...
      When I first calculated my LWR in 2014, it was a shocking 6%. Despite earning over ₹1 crore during my career, poor money habits left me with little to show for it. By focusing on saving, investing, and minimizing financial leaks, I raised my LWR to over 70% within a decade.  
